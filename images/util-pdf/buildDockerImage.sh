...
build_docker_image() {
    ...
    local REPOSITORY="${util_pdf_repository}";
    local VERSION="${util_pdf_version}";
    local PARENT_REPOSITORY="${util_pdf_parent_repository}";
    local PARENT_VERSION="${util_pdf_parent_version}";
