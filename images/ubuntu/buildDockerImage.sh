...
build_docker_image() {
    ...
    local REPOSITORY="${ubuntu_repository}";
    local VERSION="${ubuntu_repo_version}";
    local PARENT_REPOSITORY="${ubuntu_parent_repository}";
    local PARENT_VERSION="${ubuntu_parent_version}";
