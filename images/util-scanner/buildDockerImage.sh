...
build_docker_image() {
    ...
    local REPOSITORY="${util_scanner_repository}";
    local VERSION="${util_scanner_version}";
    local PARENT_REPOSITORY="${util_scanner_parent_repository}";
    local PARENT_VERSION="${util_scanner_parent_version}";
