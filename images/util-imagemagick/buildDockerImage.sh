...
build_docker_image() {
    ...
    local REPOSITORY="${util_imagemagick_repository}";
    local VERSION="${util_imagemagick_version}";
    local PARENT_REPOSITORY="${util_imagemagick_parent_repository}";
    local PARENT_VERSION="${util_imagemagick_parent_version}";
