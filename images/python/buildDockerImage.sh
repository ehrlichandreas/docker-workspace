...
build_docker_image() {
    ...
    local REPOSITORY="${python_repository}";
    local VERSION="${python_repo_version}";
    local PARENT_REPOSITORY="${python_parent_repository}";
    local PARENT_VERSION="${python_parent_version}";
